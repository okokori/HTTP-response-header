...
if __name__ == "__main__":
    ...
    if args.guide:
        print("""
            Proje Hakkında Rehber 

        Bu Python betiği, HTTP başlıklarını inceleyerek web sitelerinin güvenlik durumunu kontrol etmek için tasarlanmıştır.
        Betik, belirli bir URL'yi hedefleyerek ve ilgili HTTP başlıklarını kontrol ederek aşağıdaki işlemleri gerçekleştirebilir:

        1. HTTP Başlıklarını Listele: Bu seçenek, belirli bir URL'nin yanıt başlıklarını görüntüler.
        
        2. Kullanıcı Belirlediği HTTP Response Headers Başlıkları Kontrol Et: Bu seçenek, kullanıcının belirlediği HTTP yanıt başlıklarını kontrol eder.
        
        3. Belirli bir URL'nin HTTP Yanıt Başlıklarını ve Default Başlıkları Göster: Bu seçenek, belirli bir URL'nin HTTP yanıt başlıklarını ve güvenlikle ilgili başlıkları gösterir.
        
        4. Çıkış: Betiği sonlandırır.

        Betiği kullanırken, bu seçenekleri takip edebilir ve web sitelerinin güvenlik başlıklarını kontrol edebilirsiniz. 
        Betik, web uygulamalarınızın güvenliğini artırmak ve potansiyel güvenlik açıklarını tespit etmek için kullanışlı bir araç olabilir.
        """)
